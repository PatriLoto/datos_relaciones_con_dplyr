...
output:
  xaringan::moon_reader:
    css: [default, ki , metropolis-fonts]
    nature:
      autoplay: 30000  
...
<img src="relational-nycflights.svg" width="50%" align="center" />
...
La primera herramienta que miraremos para combinar pares de variables es la __unión de transformación__ (**_mutating join_**). Una unión de transformación te permite combinar variables a partir de dos tablas. 
...
---
Fuente:
.footnote[[*]El libro [R4DS]() y las slides de [Robust tools] de DjNavarro (https://github.com/gnab/remark/issues/142) in the future.]
---