...
class: inverse, center, middle
Motivación: en la vida real necesitaremos trabajar con más de una tabla, por lo que será de suma utilidd aprender a unir dos o más set de datos, para esto existe un conjuntos de verbos que facilitan las **uniones** o  **JOIN**
---
# Dataset
