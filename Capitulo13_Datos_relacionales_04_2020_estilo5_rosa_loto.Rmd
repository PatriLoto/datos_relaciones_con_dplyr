...
### Relaciones: Una clave primaria y su correspondiente clave foránea en otra tabla forman una relación. Existen diferentes tipos de relaciones.

 Uniones: Una unión es una forma de conectar cada fila en x con cero, una o más filas en y.

## Familias de verbos para trabajar entre pares de tablas
### Uniones de transformación: 
      * uniones internas o  inner join:

      * uniones externas: 
                  left_join o unión izquierda 
                  right_join o unión derecha
                  full_join o unión completa

### Uniones de filtrado: Las uniones de filtro unen observaciones de la misma forma que las uniones de transformación pero afectan a las observaciones, no a las variables.
